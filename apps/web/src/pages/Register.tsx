  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/40 p-4">
      <Card className="w-full max-w-sm">
        <CardBody>
          <h1 className="mb-1 text-xl font-semibold tracking-tight">创建账号</h1>
          <p className="mb-6 text-sm text-muted-foreground">立即开始使用</p>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            已有账号？<Link className="font-medium text-foreground underline-offset-4 hover:underline" to="/login">前往登录</Link>
          </p>
        </CardBody>
      </Card>
    </div>
