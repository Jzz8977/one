  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card>
          <CardBody>
            <div className="text-sm text-muted-foreground">可用积分</div>
            <div className="mt-2 text-3xl font-semibold text-primary">{account?.balance ?? 0}</div>
          </CardBody>
        </Card>
        <Card>
          <CardBody>
            <div className="text-sm text-muted-foreground">冻结积分</div>
